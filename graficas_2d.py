...
# Dibujar texto
# --------------------
texto_1 = c.create_text(BASE/4, ALTURA/4,anchor="center", text="Juan", font=("Arial", 25, "bold"),fill="blue", activefill="yellow")
...
# Poligonos
# --------------------
plogono_1 = c.create_polygon(0, 0, BASE/2, ALTURA/2,0, ALTURA, fill="red",outline="red")
